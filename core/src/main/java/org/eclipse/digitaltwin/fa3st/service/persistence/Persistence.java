 ...
 */
package org.eclipse.digitaltwin.fa3st.service.persistence;
...
public interface Persistence<C extends PersistenceConfig> extends Configurable<C> {
    ...
    /**
     * Gets an {@code org.eclipse.digitaltwin.fa3st.common.model.api.operation.OperationResult} by its handle.
     *
     * @param handle the handle
     * @return the {@code org.eclipse.digitaltwin.fa3st.common.model.api.operation.OperationResult}
    ...
    /**
     * Save a {@code org.eclipse.digitaltwin.fa3st.common.model.api.operation.OperationResult}.
     *
     * @param handle the handle of the {@code org.eclipse.digitaltwin.fa3st.common.model.api.operation.OperationResult}
     * @param result the {@code org.eclipse.digitaltwin.fa3st.common.model.api.operation.OperationResult} to insert
     * @throws PersistenceException if there was an error with the storage.
     */
