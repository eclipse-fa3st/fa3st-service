...
import org.eclipse.digitaltwin.fa3st.service.persistence.PersistenceConfig;
...
public class PersistenceFileConfig extends PersistenceConfig<PersistenceFile> {
     ...
     *
     * @throws org.eclipse.digitaltwin.fa3st.service.exception.ConfigurationInitializationException if initialModelFile
     *             is present and cannot be parsed
     * @throws org.eclipse.digitaltwin.fa3st.service.exception.ConfigurationInitializationException if dataDir is not a
     *             valid path
     */
